...
# MAGIC %md
# MAGIC ### Step 5 - Write data to datelake as Delta

# COMMAND ----------

circuits_final_df.write.mode("overwrite").format("delta").saveAsTable("formula_one_processed.circuits")

# COMMAND ----------

# MAGIC %sql
# MAGIC 
# MAGIC SELECT * FROM formula_one_processed.circuits;
