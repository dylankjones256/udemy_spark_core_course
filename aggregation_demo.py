...
# MAGIC %md
# MAGIC ### A demo to try the aggregation commands in PySpark
...
# MAGIC %md
# MAGIC ### Step 1 - Filtering data to make it easier to work with
...
# MAGIC %md
# MAGIC ### Step 2 - Importing functions for some sample aggregations
...
# MAGIC %md
# MAGIC ### Step 3 - Using groupBy and GroupedData.agg to perform multiple aggregations on grouped data
